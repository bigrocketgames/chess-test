import { ADD_HISTORY_SUCCESS, RESET_HISTORY_SUCCESS, REWIND_HISTORY_SUCCESS } from './actions';

const initialState = [{ gameState: { board: [
...
], turnColor: "White"}, message: "Beginning of the game.", id: 1}]
